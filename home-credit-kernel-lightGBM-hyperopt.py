...
def feature_generation(DATA_DIR):
    num_rows = None
    df = application_train_test(DATA_DIR, num_rows)
...
bayes_trials = Trials()
best = fmin(fn=objective, space=space, algo=tpe.suggest, max_evals=10000, trials=bayes_trials, 
